...
<div id="j-main-container" class="span10">
 <form action="index.php?option=com_subs&view=addsubs" method="post"
	id="adminForm" name="adminForm">
     <h1><?php echo $this->msg; ?></h1>
     This component allows you to manage the Subs administration.<p>
     The links on the left are for: <b>Update</b>
     <?php 
     $link = JRoute::_('index.php?option=com_subs&task=addsub.addsubscriptions');
     ?>
     ...
     <ul>
		...
		<input type="hidden" name="option" value="com_subs" />
